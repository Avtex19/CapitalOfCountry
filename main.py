...
class CapitalOfCountries:
    ...
    def __init__(self, window):
        ...
        self.informationText = Label(self.window, fg='white', bg='black',
        ...
        self.textEntry = Entry(self.window, width=30, bg='white', fg="black", font=('arial', 16, 'bold'))
        ...
        self.output = Text(self.window, width=75, height=3, wrap=WORD, bg="white", fg="black",
                           font=('arial', 16, 'bold'))
        self.output.place(anchor=CENTER, relx=.5, rely=.85)

        self.exit_button = Button(window, text="EXIT", width=14, command=self.close_window, font=('arial', 20, 'bold'),
                                  bg="DodgerBlue2",
                                  fg="black")
    ...
    def click(self):
        ...
        if text_input in self.d.keys():
            ...
            self.output.insert(END, "Sorry, can not find such a word, please try another one")
